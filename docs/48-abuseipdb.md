...
* Attribution footer: `Reported via RDP Monitor https://github.com/paulmann/1st-RDPMon`.
...
counter queries observe the same source of truth.
...
* Buttons: `Save settings`, `Test key`, `Refresh status`.
