...
public sealed class RdpAuditTagHelperTests
{
	...
	public void BuildComment_ProducesExactMandatedFormat()
	{
		...
		Assert.Equal("[rdpaudit: rdp blocklist drop] https://github.com/paulmann/1st-RDPMon", comment);
	}
	...
	public void BuildComment_FallsBackToManaged_WhenPurposeBlank()
	{
		...
		Assert.Equal("[rdpaudit: managed] https://github.com/paulmann/1st-RDPMon", comment);
	}
	...
	public void BuildComment_TrimsPurpose()
	{
		...
		Assert.Equal("[rdpaudit: service account] https://github.com/paulmann/1st-RDPMon", comment);
	}

	[Theory]
	[InlineData("[rdpaudit: drop] https://github.com/paulmann/1st-RDPMon", true)]
