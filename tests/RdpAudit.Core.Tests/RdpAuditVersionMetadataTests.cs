...
// Purpose: Pins the current release version to exactly 1.3.4 across every assembly metadata
...
/// <summary>Locks the released version metadata at exactly 1.3.4 across the Core assembly,
...
{
	private const string ExpectedSemVer = "1.3.4";
	private const string ExpectedFourPart = "1.3.4.0";
