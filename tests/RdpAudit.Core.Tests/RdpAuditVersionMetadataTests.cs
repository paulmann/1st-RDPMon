...
// Purpose: Pins the current release version to exactly 1.3.5 across every assembly metadata
...
/// <summary>Locks the released version metadata at exactly 1.3.5 across the Core assembly,
