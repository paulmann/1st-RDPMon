...
// Purpose: Pins the current release version to exactly 1.3.2 across every assembly metadata
...
/// <summary>Locks the released version metadata at exactly 1.3.2 across the Core assembly,
...
public class RdpAuditVersionMetadataTests
{
	...
	private const string ExpectedFourPart = "1.3.2.0";
