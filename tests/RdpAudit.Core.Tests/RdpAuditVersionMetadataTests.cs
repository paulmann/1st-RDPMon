...
/// <summary>Locks the released version metadata at exactly 1.3.8 across the Core assembly,
...
{
	private const string ExpectedSemVer = "1.3.8";
	private const string ExpectedFourPart = "1.3.8.0";
