...
/// <summary>Locks the released version metadata at exactly 1.4.3 across the Core assembly,
...
{
	private const string ExpectedSemVer = "1.4.3";
	private const string ExpectedFourPart = "1.4.3.0";
