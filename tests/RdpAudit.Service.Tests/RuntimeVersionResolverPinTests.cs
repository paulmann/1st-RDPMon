...
//          1.3.4 — the SemVer publish.ps1 emits and the value the Configurator's Service tab
...
/// <summary>Pins the Service runtime version at exactly 1.3.4, blocking both the prior 1.0.0
