...
//          1.2.3 — the SemVer publish.ps1 emits and the value the Configurator's Service tab
...
//          and the resolver path the running service actually uses at runtime. The 1.2.3 bump
//          accompanies the firewall/UI stabilisation pass and the new GetFirewallDiagnostics
...
/// <summary>Pins the Service runtime version at 1.2.3.</summary>
