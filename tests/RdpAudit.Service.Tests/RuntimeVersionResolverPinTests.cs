...
//          1.1.0 — the SemVer publish.ps1 emits and the value the Configurator's Service tab
...
/// <summary>Pins the Service runtime version at 1.1.0.</summary>
public class RuntimeVersionResolverPinTests
{
	...
	[Fact]
	public void Resolve_FromServiceAssembly_ReturnsExactly110()
	{
	...
	[Fact]
	public void Resolve_NeverReportsLegacy120()
	{
		Assembly serviceAssembly = typeof(RuntimeVersionResolver).Assembly;
		string version = RuntimeVersionResolver.Resolve(serviceAssembly, processPath: null);
